...
<head>
    ...
    <title>clck-game. - Регистрация аккаунтаыв!</title>
    <meta property="og:title" content="clck-game. - Регистрация аккаунта">
...
<body>
    ...
    <form class="form-signin" action="cheak_reg.php" method="post">
        ...
        <h1 class="h3 mb-3 font-weight-normal">Зарегестрироваться либо <a href="/source/php/login.php">войти</a></h1>
